		...
		<div class="container" id="fastBuyOpenContainer">
			...
			<div class="column">
				...
				<form action="<?=SITE_DIR?>callback/" id="fastBuyForm" method="GET">
					...
					<div class="formLine"><input type="checkbox" name="personalInfoFastBuy" id="personalInfoFastBuy"><label for="personalInfoFastBuy">Я согласен на <a href="/personal-info/" class="pilink">обработку персональных данных</a> и с <a href="/oferta/" class="pilink">договором оферты</a>.*</label></div>
