...
Array(
	...
	Array(
		...
		"PICTURE_HEIGHT" => "200",
		"PICTURE_WIDTH" => "220",
		"PRODUCT_PRICE_CODE" => array("Розничные"),
		"PROP_NAME" => "OFFERS",
		"PROP_VALUE" => array("_11654","_11656","_11657","_11655"),
		"SORT_PROPERTY_NAME" => "CATALOG_PRICE_2",
		"SORT_VALUE" => "ASC"
	),
false,
Array(
...
);?> <!-- начало виджет инстаграм --> <script src="https://apps.elfsight.com/p/platform.js" defer></script>
<div class="elfsight-app-e2db772f-7211-4239-bb67-d39c7efa9b87">
</div>
<!-- окончание виджет инстаграм --><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>